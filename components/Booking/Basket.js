            ...
            <div id="ticket-template">
              <div className="posts">
                <div className="post-quantity-remove">
                  <h4 className="turquoise type">{props.cartReg.displayname.value}</h4>
                  <h5 className="white price">Ticket price: DKK {props.cartReg.price.value}</h5>
                </div>
                <div className="post-type-price">
                  <h4 className="turquoise type">x{props.cartReg.amount.value}</h4>
