  ...
  return (
    <footer>
      ...
      <div className="footer-col2">
        ...
        <div className="newsletter">
          <div className="subscribe-field">
            <input type="text" name="subscribe" id="subscribe" placeholder="johndoe@mail.com" className="input-text" required />
            <span className="error-message">Enter a valid value</span>
            <label forhtml="card">Subscribe</label>
          </div>
      ...
      <div className="footer-col3">
        <h3>Contact</h3>
        <p>
          Cosmo Festival<br></br>Jagtej 16, 3000, Denmark<br></br>hello@cosmofestival.com<br></br>CVR: 33814860
        </p>
        <ul className="some">
          <li>
